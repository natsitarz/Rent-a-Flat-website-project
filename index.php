...
<body>
    ...
    <div id="main">
        ...
        <div class="container">
            <div class="row" id="c1">
                <div class="b1 col-md-6" id="title">
                    <p class="h1">ul. lorem ipsum</p>
                    <p class="lead ttl">Krakowska Krowodrza</p>
                    <p class="lead tc1 tcm ttl">Mieszkanie przeznaczone dla 2 osób</p>
                </div>
                <div class="b1 col-md-6 title">
        ...
        <div class="container">
            <div class="row">
                <div class="embed-responsive embed-responsive-16by9 b1 col-md-6 title">
                    <iframe class="embed-responsive-item" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d327952.4182831036!2d19.724694226515123!3d50.0464284278981!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x471644c0354e18d1%3A0xb46bb6b576478abf!2zS3Jha8Ozdw!5e0!3m2!1spl!2spl!4v1668850379483!5m2!1spl!2spl"
                ...
                <div class="b1 col-md-6">
                    <p class="lead tc1 ttr">Mieszkanie znajduje się przy ul. lorem ipsum na Krakowskiej Krowodrzy.
                    </p>
                    <p class="lead tc2 ttr">5 minut pieszo od przystanków tramwajowych i autobusowych. 25 minut pieszo do rynku spacerkiem i 2 przystanki tramwajem od rynku. Przy samej kamienicy sklep żabka i biedronka. Parking miejski pod kamienica platny wg taryfy miejskiej
                        strefy C.</p>
                </div>
            </div>
        </div>
        ...
        <form class="form-group" id="contact-form" name="contact-form" action="mail.php" method="POST">
            <div class="inf">
                ...
                <input type="date" id="start" name="start" value="2022-04-02" min="2022-01-01" max="2023-12-31"><br>
                <label for="end" class="lead tc1">Do: </label>
                <input type="date" id="end" name="end" value="2022-04-03" min="2022-01-01" max="2023-12-31"><br>
            </div>
        </form>
        <button type="submit" value="Wyślij" class="btn btn-dark inf" onclick="document.getElementById('contact-form').submit();" name="submit_btn">Wyślij</button>
    ...
    <footer class="bg-dark text-center" id="footer">
        <div class="text-center p-1">
            <h6 class="text-light">Kontakt | Telefon: lorem ipsum lub lorem ipsum | E-Mail: lorem.ipsum@gmail.com
            </h6>
        </div>
    </footer>
